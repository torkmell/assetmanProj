...
ETF_data = yf.download(tickers, interval= "1mo", start="2000-01-01", end="2020-03-31")
...
import os
os.chdir('C:/Users/joses/OneDrive/Desktop/BootQuant Finance/Modulos/2_Factores_MacroMercado_TAA')
macro_factors = pd.read_csv("Macro Data/fred_data_macro_factors.csv")
...
print(model_logit.pvalues[0]) # to retrieve p-values, 
